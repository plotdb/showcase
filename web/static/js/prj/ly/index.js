...
$(document).ready(function(){
  var lg;
  lg = {};
  return d3.json('/assets/prj/ly/mly-8-with-sex.json', function(data){
    var d2, i$, len$, it;
    d2 = new Date();
    ...
    return d3.json('/assets/prj/ly/ttsinterpellation.compact.json', function(data){
        ...
        */
        ...
        d3.select('#asked-by').selectAll('div.avatar').each(function(d){
          ...
          x$.select('img').attr('src', function(){
            ...
            return "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAAGXRFWHRTb2Z0d2FyZQBBZG9iZSBJbWFnZVJlYWR5ccllPAAAABBJREFUeNpi+P//PwNAgAEACPwC/tuiTRYAAAAASUVORK5CYII=";
      ...
      d3.json('/assets/prj/ly/twCounty2010.topo.json', function(data){
        var prj, path, svg;
        d41 = new Date();
