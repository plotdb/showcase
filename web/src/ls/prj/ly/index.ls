...
(data) <- d3.json \/assets/prj/ly/mly-8-with-sex.json
d2 = new Date!
for it in data => lg[it.name] = it
(data) <- d3.json \/assets/prj/ly/ttsinterpellation.compact.json
d31 = new Date!
...
d3.json \/assets/prj/ly/twCounty2010.topo.json, (data) ->
  d41 := new Date!
